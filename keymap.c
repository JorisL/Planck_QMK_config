...
[_LAYER4] = LAYOUT_planck_grid(
  KC_ESC,  KC_PSLS, KC_P7,   KC_P8, KC_P9,   KC_NO,  KC_NO,   KC_P7,   KC_P8, KC_P9,  KC_PSLS, KC_TRNS,
  KC_PEQL, KC_PAST, KC_P4,   KC_P5, KC_P6,   KC_NO,  KC_NO,   KC_P4,   KC_P5, KC_P6,  KC_PAST, KC_PEQL,
  KC_PENT, KC_PMNS, KC_P1,   KC_P2, KC_P3,   KC_NO,  KC_NO,   KC_P1,   KC_P2, KC_P3,  KC_PMNS, KC_PENT,
  KC_TRNS, KC_PPLS, KC_COMM, KC_P0, KC_DOT, KC_TRNS, KC_TRNS, KC_COMM, KC_P0, KC_DOT, KC_PPLS, KC_NO
),
